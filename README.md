...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-comment/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-comment/actions/workflows/validate.yml)

Neovim tree-sitter queries for **comment**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-comment",
...
- [ ] Changes are scoped to `comment` — do not include files for other languages
